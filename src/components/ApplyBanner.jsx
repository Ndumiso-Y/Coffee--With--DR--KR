...
export default function ApplyBanner() {
  return (
    <section id="apply" className="reveal py-20 bg-gradient-to-br from-charcoal via-deepCoffee to-warmCoffee relative overflow-hidden">
      {/* Background patterns */}
      ...
      <div className="container mx-auto px-4">
        <div className="relative">
          ...
          {/* Main card */}
          <div className="relative backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-10 md:p-16 shadow-glass">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                  <div className="flex items-center gap-3 text-white/80">
                    <div className="w-2 h-2 bg-coffeeOrange rounded-full"></div>
                    <span className="font-semibold">Year-long mentorship</span>
                  </div>
                  <div className="flex items-center gap-3 text-white/80">
              ...
              <div className="flex flex-col gap-4">
                <a
                  ...
                  className="group relative inline-flex items-center justify-center rounded-2xl bg-orange-gradient px-10 py-5 text-xl font-black text-white shadow-strong hover:shadow-glow transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 overflow-hidden"
                >
